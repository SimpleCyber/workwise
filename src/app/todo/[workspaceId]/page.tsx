...
import { Loader, Plus, TriangleAlert, MoreHorizontal, Trash2, Edit } from "lucide-react" // Added MoreHorizontal, Trash2, Edit
        ...
        <div className="mx-auto max-w-7xl">
          {!boards || boards.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {boards.map((board) => (
                <Card key={board._id} className="hover:shadow-md transition-shadow cursor-pointer">
                  <CardHeader className="relative">
                    {" "}
                    {/* Added relative for dropdown positioning */}
                    <div className="flex items-center justify-between">
                      <Link href={`/todo/${workspaceId}/board/${board._id}`} className="flex-1">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem asChild>
                            <Link href={`/todo/${workspaceId}/board/${board._id}`}>
