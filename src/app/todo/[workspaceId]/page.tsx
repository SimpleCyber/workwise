    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex h-[49px] items-center border-b bg-background px-4">
        ...
        <h1 className="text-lg font-semibold flex-1 truncate">
          {isMobile ? "Todo Boards" : `Todo Boards - ${workspace.name}`}
        </h1>
        <Button
          ...
          title="New Board"
        >
          <Plus className={isMobile ? "size-4" : "size-4 mr-2"} />
          {!isMobile && "New Board"}
        </Button>
        ...
        <ResponsiveModal
          ...
          title={editingBoardId ? "Edit Board" : "Create New Board"}
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              {sortedBoards?.map((board) => (
                <Card
                  ...
                  onClick={() =>
                    router.push(`/todo/${workspaceId}/board/${board._id}`)
                  }
                >
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1 overflow-hidden pr-4">
                        <CardTitle className="text-base flex items-center gap-2">
                          {board.isStarred && (
                            <Pin className="size-4 text-yellow-500 fill-yellow-500 flex-shrink-0" />
                          )}
                        ...
                        <DropdownMenu>
                          ...
                          <DropdownMenuContent align="end">
                            ...
                            {board.isStarred ? (
                              <DropdownMenuItem
                                onClick={() =>
                                  handleToggleStar(board._id, true)
                                }
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  handleToggleStar(board._id, false)
                                }
                                disabled={isTogglingStar}
                              >
