...
import { List, Flag, User, Calendar, Check, CircleAlert, Circle, Settings2 } from "lucide-react";
    ...
    <div className="flex flex-col h-full bg-transparent p-5">
      ...
      <div className="flex flex-col space-y-4">
              ...
              <SelectContent>
                {lists.map((list) => (
                  <SelectItem key={list._id} value={list._id}>
                    <Badge variant="secondary" className="font-normal border shadow-none bg-muted hover:bg-muted font-medium capitalize">
                      {list.name}
                    </Badge>
                  </SelectItem>
                ))}
        ...
        <div className="grid grid-cols-[100px_1fr] items-center text-sm gap-2">
          ...
          <div>
            <Select value={task.assignedToId || ""} onValueChange={handleAssigneeChange}>
