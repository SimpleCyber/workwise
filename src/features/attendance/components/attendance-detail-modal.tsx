...
import { CheckCircle, ImageIcon, MessageSquare, Send, User, X, XCircle } from 'lucide-react';
...
export const AttendanceDetailModal = ({ attendance, workspaceId, isOpen, onClose, isAdmin = false }: AttendanceDetailModalProps) => {
                  ...
                  {isAbsent ? (
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div className="text-center p-3 bg-muted/20 rounded">
                        ...
                        <p className="font-bold">{attendance.checkOutTime ? formatTime(attendance.checkOutTime) : 'Not checked out'}</p>
                        <p className="text-xs text-muted-foreground mt-1">
                        ...
                        {attendance.taskImage && (
                          <div className="mt-3">
                            <img
                              ...
                              onClick={() => {
                                window.open(`${process.env.NEXT_PUBLIC_CONVEX_URL}/api/storage/${attendance.taskImage}`, '_blank');
                              }}
                            />
                          </div>
                        )}
                ...
                <Card>
                  ...
                  <CardContent className="p-4 pt-0 space-y-3">
                    ...
                    <div className="flex gap-2">
                      <Button onClick={() => handleStatusUpdate('approved')} disabled={isUpdating} size="sm" className="flex-1">
          ...
          <div className="p-4 border-t bg-background">
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button onClick={handleAddComment} disabled={isAddingComment || (!comment.trim() && !commentImage)} size="sm">
